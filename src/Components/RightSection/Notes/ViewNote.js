...
function ViewNote({ note, setViewNoteMode }) {
    return (
            ...
            <div className="innerViewNote p-4">
                <div className="d-flex justify-content-between">
                    ...
                    <div className="viewNoteOptions">
                        ...
                        <img onClick={() => setViewNoteMode(() => ({ mode: false, note: {} }))} alt="" width="10" src="https://ik.imagekit.io/36h35rdxx/Vector_pa1Qr-2e6u.png?ik-sdk-version=javascript-1.4.3&updatedAt=1653657497834" />
                    </div>
                </div>
